                    ...
                    <div className="bg-white/10 backdrop-blur-md p-6 rounded-xl shadow-md hover:bg-white/15 transition-all">
                        ...
                        <div className="space-y-4">
                            ...
                            >
                                ...
                                <div className="flex-1">
                                    <div className="text-yellow-300 font-semibold mb-1">Akash</div>
                                    <div className="text-gray-200"><span className="italic">laughs</span> Brooo, why don't we make a <span className="text-yellow-300 font-bold">Result Analysis Application</span>? Something way bigger and cooler than what we ever did.</div>
                                </div>
                            </motion.div>
                    ...
                    <div className="bg-white/10 backdrop-blur-md p-6 rounded-xl shadow-md hover:bg-white/15 transition-all">
                        ...
                        <div className="space-y-4">
                            ...
                            >
                                ...
                                <div className="flex-1">
                                    <div className="text-white font-semibold mb-1">Ayush</div>
                                    <div className="text-gray-200"><span className="italic">dramatic sigh</span> In memory of <span className="text-yellow-300">.....</span> <span className="text-pink-400">😉♥️✈️</span></div>
                                </div>
                            </motion.div>
