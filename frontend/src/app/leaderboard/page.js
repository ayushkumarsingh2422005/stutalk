...
export default function Leaderboard() {
  ...
  const fetchLeaderboardData = async () => {
    try {
      ...
      const url = new URL(`${process.env.NEXT_PUBLIC_API_URL}/api/leaderboard`);
    ...
    >
      ...
      >
        ...
        <div className="flex items-center gap-4">
          <Link href="/leaderboard" className="text-yellow-300 transition-colors">
            <motion.div
          ...
          >
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              ...
              <div>
                ...
                >
                  {batches.map((b) => (
                    <option key={b.value} value={b.value} className="bg-gray-800">
                      {b.label}
                    </option>
                  ))}
                </select>
              ...
              <div>
                ...
                <select
                  ...
                  className="w-full bg-gray-800/50 border border-gray-700 text-white rounded-lg py-2 px-3 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all duration-200"
                >
                  <option value="all" className="bg-gray-800">All Semesters</option>
